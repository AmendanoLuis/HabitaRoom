...
<div class="container-fluid text-light">
    <div class="row ">
        ...
        <div class="col-2 col-md-3">
            ...
            <!-- Categoria | >= Medium -->
            <div class="row position-fixed d-lg-block d-none z-1 bg-light shadow-lg">
                <div class="col">
                    <div class="container mt-5 pt-3 px-5  mb-5 rounded-bottom text-body-secondary">
                ...
                <div class="accordion accordion-flush">
                    <div class="accordion-item">
                        ...
                        <h2 class="accordion-header">
                            <button
                                class="accordion-button bg-success bg-opacity-75 p-3 rounded-end text-light fs-md-6 fs-sm-5"
        ...
        <div class="col-10 col-md-9 pt-3 mt-5 d-flex flex-column align-items-center" id="contenedor-principal">
        ...
        <div class="botones_accion position-fixed bottom-0 end-0 m-3 ">
            <div class="position-relative w-100" style="height: 22vh;">

                <!-- Contenedor para el Chat -->
                <div id="chat-container" class="position-absolute top-0 end-0 ">
                ...
                <div id="map-container" class="position-absolute top-50 end-0 translate-middle-y ">
                    <button class="btn btn-light p-2 px-3 rounded-circle border border-1 border-success">
