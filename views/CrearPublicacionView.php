<div class="container-lg d-flex flex-column align-items-center text-light crear-publicacion">
    <div class="row mt-5 text-dark">
        <div class="col" style="min-width:550px;">
            <h2 class="text-justify mx-auto">Crear tu anuncio</h2>

            <!-- Formulario -->
            <form class="mt-3">

                <!-- Tipo de inmueble -->
                <div class=" container form-group mb-3 position-relative mt-4 mb-3">
                    <label for="tipo-inmueble" class="position-absolute top-0 start-0 pt-2" id="label-tipo-inmueble">Tipo de inmueble</label>
                ...
                <div class=" container mt-5 mb-3">
                    ...
                    <div id="mapa" class="d-flex flex-column align-items-center mx-auto mt-3 w-100">
                        <iframe class="h-100 mb-3" width="500px" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d10694.649359839766!2d-3.584114235826003!3d37.16367693815794!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0xd71e3532fc629bb%3A0x3f04a1335378ec94!2sAsador%20Curro!5e0!3m2!1ses!2ses!4v1739023651029!5m2!1ses!2ses"></iframe>
                        <form class=" p-3 d-flex justify-content-center align-items-center bg-success bg-opacity-75 rounded-bottom" id="formBuscarMapa">
                            <div class="input-group mb-3">
                                <input type="text" class="form-control" placeholder="Buscar ubicación" aria-label="Buscar ubicación" aria-describedby="button-addon">
                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="input-group flex-nowrap ">
                                <input type="text" class="form-control" placeholder="Título" aria-label="Username" aria-describedby="addon-wrapping">
                            </div>
                        </div>
                        <div class="col-6">
                            <!-- Precio -->
                    ...
                    <div class="d-flex justify-content-start align-items-center">
                        ...
                        <div class="me-5 ">
                            ...
                            <div class="d-flex align-items-center mt-2 ">
                                <button class="btn btn-outline-success  fs-5 rounded-circle px-3 fw-bold" id="btn-menos-hab"> - </button>
                                <span id="num-habitaciones" class="mx-3 pe-1"> 1 </span>
                                <button class="btn btn-outline-success  fs-5 rounded-circle ps-3 pe-3 fw-bold" id="btn-mas-hab"> + </button>
                            </div>
                        </div>
                        <!-- Número de baños -->
                        <div class="ms-5">
                            <h5>Baños</h5>
                            <div class="d-flex align-items-center mt-2 ">
                                <button class="btn btn-outline-success  fs-5 rounded-circle px-3 fw-bold" id="btn-menos-banos">-</button>
                                <span id="num-banos" class="mx-3 pe-1">1</span>
                                <button class="btn btn-outline-success  fs-5 rounded-circle ps-3 pe-3 fw-bold" id="btn-mas-banos">+</button>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-0 mb-4">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <label class="btn btn-outline-primary w-100 rounded-0" for="aireAcondicionado">Aire Acondicionado</label>
                                </div>
                            ...
                            <div class="btn-group flex-wrap" role="group" aria-label="Estado">
                ...
                <!-- Superficie en m2 -->
                <div class="container mt-5 mb-3">
                    <h5>Superficie construida <span class="text-muted">(opcional)</span></h5>
                    <div class="input-group mb-3">
                        <input type="text" class="form-control border-end-0" id="superficie" name="superficie" aria-label="Sizing example input" aria-describedby="inputGroup-sizing-default">
                ...
                <div class="container mt-5 mb-3">
                    <h5>Descripción</h5>
                    <textarea class="form-control" id="descripcion" name="descripcion" rows="6" placeholder="Proporciona una descripción detallada del inmueble, incluyendo su distribución, estado de conservación, características especiales y cualquier otra información relevante que pueda interesar a los posibles compradores o inquilinos." required></textarea>
                </div>

                <!-- Subir imágenes -->
                <div class="container mt-5 mb-3">
                    <h5>Fotos y vídeos <span class="text-muted">(opcional)</span></h5>
                ...
                <div class="container mt-5 mb-3">
                    <h5>Contacto <span class="text-muted">(opcional)</span></h5>
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row g-0 mb-4">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <label class="btn btn-outline-success w-100 rounded-0 rounded-start-2 " for="contacto-mensaje">Mensaje</label>
                                </div>

                                <!-- Teléfono -->
                                <div class="col-md-3">
                                    <input type="checkbox" class="btn-check" id="contacto-telefono" autocomplete="off">
                                    <label class="btn btn-outline-success w-100 rounded-0" for="contacto-telefono">Teléfono</label>
                                </div>

                                <!-- Whatsapp -->
                                <div class="col-md-3">
                                    <input type="checkbox" class="btn-check" id="contacto-wasap" autocomplete="off">
                                    <label class="btn btn-outline-success w-100 rounded-0 rounded-end-2 " for="contacto-wasap">Whatsapp</label>
                                </div>
